#!/bin/bash
# Provision G4 per AI-Hypercomputer gpu-recipes: g4-standard-48 (1 GPU) + Ubuntu 24.04 nvidia-570 accel image.
# Set your own GCP project id (or export PROJECT_ID before running).
...
LOG="$HOME/g4_recipe.log"; echo "start $(date -u +%FT%TZ)" > "$LOG"
